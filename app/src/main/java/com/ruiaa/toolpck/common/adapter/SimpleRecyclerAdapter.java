package com.ruiaa.toolpck.common.adapter;
...
public class SimpleRecyclerAdapter<T> extends BaseRecyclerAdapter {
    ...
    protected ItemDataBinding<T> itemDataBinding;
    protected ItemListenerBinding<T> itemListenerBinding;
    ...
    public SimpleRecyclerAdapter(Context context, int itemLayoutId, List<T> list, ItemDataBinding<T> itemDataBinding, ItemListenerBinding<T> itemListenerBinding) {
        this.context = context;
        this.itemLayoutId = itemLayoutId;
        this.list = list;
        this.itemDataBinding = itemDataBinding;
